...
#%if "%{?commit}" != ""
#Patch0: %{version}..%{version}-rc1.patch
#Patch1: %{version}-rc1..%{commit}.patch
#%endif
Patch0: 21.04..21.04-rc.patch
Patch1: 21.04-rc1..5e4fe0adc81c0fd2d5c70fb9ddd3ee3a3082bdc4.patch
